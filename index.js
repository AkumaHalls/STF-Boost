...
function setupListenersForAccount(account) {
    ...
    account.client.on('error', (err) => { account.status = "Erro"; account.sessionStartTime = null; });
...
async function loadAccountsIntoMemory() {
    const defaultSettings = { customInGameTitle: '', customAwayMessage: '', appearOffline: false, autoAcceptFriends: false, autoRelogin: true }; // Auto-Relogin ativado por defeito
...
// --- CONFIGURAÇÃO DA APLICAÇÃO E ROTAS (sem alterações) ---
